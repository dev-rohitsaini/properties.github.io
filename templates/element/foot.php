    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2021 Shadu Properties. All Rights Reserved <i class="fa fa-heart"></i>  <a href="http://wpexpand.com" target="_blank"></a></p>
                    </div>
                </div>
