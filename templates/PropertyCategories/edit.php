...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $propertyCategory->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $propertyCategory->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="propertyCategories form content">
            ...
            <fieldset>
                <legend><?= __('Edit Property Category') ?></legend>
                <?php
